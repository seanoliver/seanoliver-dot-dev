    ...
    <Section title="About">
      <div className="About">
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          I’m an AI engineer who loves building and growing products that leverage AI that solve
          important problems in surprising and delightful ways. I have 13 years of experience
          building and growing products at leading companies like{' '}
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          knowledge management, AI, tennis, and casual mobile games.
        </p>
      </div>
    </Section>
  )
