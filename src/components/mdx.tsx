...
export const mdxComponents: MDXComponents = {
    ...
    h2: (props) => <h2 {...props} className='mt-4 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0' />,
    h3: (props) => <h3 {...props} className='scroll-m-20 text-2xl font-semibold tracking-tight' />,
    h4: (props) => <h4 {...props} className='scroll-m-20 text-xl font-semibold tracking-tight' />,
    h5: (props) => <h5 {...props} className='text-md leading-5 mb-4' />,
    h6: (props) => <h6 {...props} className='text-sm leading-4 mb-4' />,
    ...
    // pre: (props) => <pre {...props} className='bg-gray-100 my-4 text-sm rounded-md p-4 md:-mx-20 overflow-auto' />,
    code: (props) => <code {...props} className={!props['data-theme'] && 'relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold'} />,
