    ...
    <Section title="Reading">
      <div className="">
        <p className="leading-7">
          ...
          a trip to China when I gulped down <i>Bad Blood</i>, <i>Educated</i>, and a few other
          totally kickass books. I aim to &quot;read&quot; about 30 books per year, and usually hit
          it.
        </p>
        <br />
